...
const ReputationPage = () => {
  ...
  const {
    ...
    refetch: refetchReceivedRatings,
  } = trpc.user.getReceivedRatings.useQuery(undefined, {
  ...
  const {
    ...
    refetch: refetchGivenRatings,
  } = trpc.user.getGivenRatings.useQuery(undefined, {
    enabled: status === "authenticated",
  });
        ...
        <div className="bg-white border-2 border-black rounded-lg shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] mb-6">
          ...
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-2">
              Community reputation based on {receivedRatings?.length || 0}{" "}
              reviews
            </p>
              ...
              <div className="flex">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star
                    ...
                    size={20}
                    fill={
                      Number(averageRating) >= star ? "currentColor" : "none"
                    }
        ...
        {hasRatings ? (
          <div className="space-y-4">
            {currentRatings.map((rating: Rating) => (
              <div
                key={rating.id}
                className="bg-white border-2 border-black rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-4"
              >
                ...
                <div>
                  <p className="text-sm text-gray-600 mb-2">
                    ...
                    {rating.exchange.providerService?.title || "Service"}
                  </p>
                  {rating.comment && (
                    <p className="text-sm border-t border-gray-200 pt-2 mt-2">
                      {rating.comment}
                    </p>
                  )}
                </div>
