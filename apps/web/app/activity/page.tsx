...
const ActivityPage: React.FC = () => {
  ...
  const {
    ...
    error,
    refetch,
  } = trpc.exchange.getRecentActivity.useQuery(
  ...
  const barChartData = useMemo(() => {
    ...
    for (let i = 5; i >= 0; i--) {
      ...
      months.push(
        d.toLocaleDateString("en-US", { month: "short" }).substring(0, 3)
      );
    }
      ...
      <div className="min-h-screen flex items-center justify-center bg-red-50 p-4">
        <div className="bg-white p-6 border-2 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] rounded-lg text-center max-w-md">
          ...
          <p className="text-sm text-gray-600 mb-4 leading-normal">
            Could not load your activity history. Please try again later.
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-blue-50 font-inter pb-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="relative mb-8">
            <h1 className="font-satoshi tracking-tight text-3xl font-bold text-black">
              Activity History
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8 mb-8">
            ...
            <div className="bg-white border-2 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] rounded-lg p-5">
              <div className="flex items-center mb-1">
                ...
                <h2 className="font-satoshi tracking-tight text-xl font-bold text-black">
                  Exchange Activity
                </h2>
              </div>
              <p className="text-sm text-gray-600">
                Completed exchanges per month
              </p>
