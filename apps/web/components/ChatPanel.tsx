...
const ChatPanel: React.FC<ChatPanelProps & { className?: string }> = ({
  exchangeId,
  userId,
  className = "",
}) => {
  ...
  return (
    <div
      className={`border-2 border-black bg-white p-4 rounded-lg shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] font-satoshi flex flex-col ${className}`}
    >
